...
<html xmlns="http://www.w3.org/1999/xhtml"> <!-- 修改密码模块 -->
	<head>
        ...
        <script language="javascript">
            function check()
            {
                 var userPwReal="${sessionScope.user.loginpw}"; //从session范围里取得管理员的密码，赋值给userPwReal
			...
			<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC" style="margin-bottom:8px">
				...
				<tr bgcolor="#FFFFFF">
				    ...
				    <td width="75%" bgcolor="#FFFFFF">
				        <input type="text" value="${sessionScope.user.name }" name="userName" size="20" disabled="disabled"/> 
